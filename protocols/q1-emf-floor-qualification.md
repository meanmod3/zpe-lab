...
| Q1.3 | Lock-in amplitude at f_mod, piezo ON, mirror MOVING over dummy, ≥3 h | < **10 pA** equivalent (f_mod-synchronous microphonics bound) | 513 budget row 2; 10 pA = 5000× below claimed 50 nA |
